Public Class UserControlDateinamePOSTAUSGANG
    ...
    'Private xmlBeaEMPFAENGER As Xml.XmlDocument
    'Private xmlBeaBEZEICHNUNGEN As Xml.XmlDocument
    'Private xmlPostBEZEICHNUNGEN As Xml.XmlDocument
    'Private xmlPostABSENDER As Xml.XmlDocument
    'Private xmlAkteBEZEICHNUNGEN As Xml.XmlDocument
    'Private xmlRechnungBEZEICHNUNGEN As Xml.XmlDocument
    'Private xmlRechnungEMPFAENGER As Xml.XmlDocument
    'Private xmlVermerkBEZEICHNUNGEN As Xml.XmlDocument
    ...
    Private Sub resetUserInput()
        ...
        TextBoxDateinameENTWURF.Text = String.Empty
    End Sub
    ...
    Private Sub ButtonERSTELLEN_Click(sender As Object, e As RoutedEventArgs) Handles ButtonDateinameERSTELLEN.Click
        Dim s As String = ModuleDateinameErstellenPOSTAUSGANG.erstellen(Me)
        If CeckBoxMitPfad.IsChecked Then
            If Not String.IsNullOrEmpty(lopstaPROJEKTDATEN.AktivesProjekt.FullName) Then
                s = System.IO.Path.Combine(lopstaPROJEKTDATEN.AktivesProjekt.FullName, "02_Handakte", "a_Postausgang", s)
            End If
        End If
    ...
    ' =================================================================================================================
    ' Button Speichern
    ' Speichert das aktive Word Dokument mit dem angegebenen Pfad
    ' bzw. öffnet den Word-SpeichernAls Dialog zur Kontrolle.
    ' =================================================================================================================
    Private Sub ButtonDateinameSpeichern_Click(sender As Object, e As RoutedEventArgs) Handles ButtonDateinameSpeichern.Click
        Dim n As String = ModuleDateinameErstellenPOSTAUSGANG.erstellen(Me)
        Dim p As String = Nothing
        If CeckBoxMitPfad.IsChecked Then
            If Not String.IsNullOrEmpty(lopstaPROJEKTDATEN.AktivesProjekt.FullName) Then
                'n = System.IO.Path.Combine(lopstaPROJEKTDATEN.AktivesProjekt.FullName, "02_Handakte", "a_Postausgang", s)
                p = System.IO.Path.Combine(lopstaPROJEKTDATEN.AktivesProjekt.FullName, "02_Handakte", "a_Postausgang")
            End If
        End If

        TextBoxClipboard.Text = n
        ...
        lopstaWordSchnittstelleTextbausteine.ClassActiveDocumentSaveAs.DocumentSaveAs(p, n)
