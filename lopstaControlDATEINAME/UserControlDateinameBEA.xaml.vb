Public Class UserControlDateinameBEA
    ...
    Private Sub ComboBoxenMitItemsAusXmlDateiFuellen()
        ...
        Try
            xmlDateinameEMPFAENGER.Load("Resources\BeaEmpfaenger.xml")
        ...
        Try
            xmlDateinameBEZEICHNUNGEN.Load("Resources\BeaBezeichnungen.xml")
    ...
    Private Sub resetUserInput()
        ...
        TextBoxDateinameORDNUNGSNUMMER.Text = String.Empty
    End Sub
    ...
    Private Sub ButtonERSTELLEN_Click(sender As Object, e As RoutedEventArgs) Handles ButtonDateinameERSTELLEN.Click
        Dim s As String = ModuleDateinameErstellenBEA.erstellen(Me)
