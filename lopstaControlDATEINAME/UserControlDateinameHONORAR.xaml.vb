Public Class UserControlDateinameHONORAR
    ...
    Private Sub ComboBoxenMitItemsAusXmlDateiFuellen()
        ...
        Try
            xmlDateinameEMPFAENGER.Load("Resources\RechnungEmpfaenger.xml")
        ...
        Try
            xmlDateinameBEZEICHNUNGEN.Load("Resources\RechnungBezeichnungen.xml")
    ...
    Private Sub ButtonERSTELLEN_Click(sender As Object, e As RoutedEventArgs) Handles ButtonDateinameERSTELLEN.Click
        Dim s As String = ModuleDateinameErstellenHONORAR.erstellen(Me)
        If CeckBoxMitPfad.IsChecked Then
            If Not String.IsNullOrEmpty(lopstaPROJEKTDATEN.AktivesProjekt.FullName) Then
                s = System.IO.Path.Combine(lopstaPROJEKTDATEN.AktivesProjekt.FullName, "03_Rechnungen", s)
            End If
        End If
